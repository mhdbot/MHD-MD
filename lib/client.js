...
try {
    ...
    console.log("🌍 Connected to bat  database")
} catch {
...
let cc = Config.sessionName.replace(/BAT-MD;;;/gi, "").replace(/Secktor;;;/gi, ""); // Dont Remove "Secktor;;;" So that You Can Use Secktor Qr too in your bot
        ...
        Void.serializeM = (citel) => smsg(Void, citel, store)
            ...
            Void.ev.on('connection.update', async(update) => {
                ...
                if (connection === 'open') {
                    ...
                    let integrate  = "_BAT-MD has been integrated._\n_Total Plugins :"
