...
try {
    ...
    console.log("🌍 Connected to the BAT DATABASE")
} catch {
...
setTimeout(() => {
    ...
    async function syncdb() {
        ...
        const ChangePic = __dirname + "/assets/bat.png"
        await writeFile(ChangePic, thumbbuffer);
        global.log0 = fs.readFileSync(__dirname + "/assets/bat.png"); //ur logo pic
