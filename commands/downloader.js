...
let vurl=res.url[0].url;
    ...
    let data  ="*Video Name       :* "+ res.meta.title ;
        ...
        data +="\n*Video Link     :* "+  vurl;
                        ...
                        caption : "    *BAT-BOT FACEBOOK DOWNLOADER*  \n"+data
...
// citel.reply('name:-------'+info.video.title);
      ...
      let data  ="*Video Name     :* "+  info.video.title;
        ...
        //data +="\n*Video Link     :* "+  vurl;
//citel.reply("    BAT-BOT FACEBOOK DOWNLOADER  \n"+data)
//console.log(info);
        data +=Config.caption ;
                        let buttonMessage = {
                        video: {url:vurl},
...
try {
        ...
        { 
                ...
                let buttonMessage = 
                {
                        ...
                        caption : "\t  *BAT-BOT GOOGLE DRIVE DOWNLOADER*  \n" + data
                }
                return await Void.sendMessage(citel.chat,buttonMessage, { quoted: citel })
        })
...
cmd({
        ...
        async(Void, citel, text) => {
        if (!text) return await citel.send('*Provide Repo Url, Ex:- _.gitclone https://github.com/EX-BOTS/BAT-MD_*') 
        ...
        async(Void, citel, text) => {
            ...
            for (let i of search.all) {
                    listSerch.push({
                                    ...
                                    description: `*•𝙱𝙰𝚃-𝙱𝙾𝚃 𝙳𝙾𝚆𝙽𝙻𝙾𝙰𝙳𝙴𝚁•* / ${i.timestamp}`
                                       })
            }
            const sections = [{
